...
const FileMenu = () => {
	const { createDocument, saveDocument, closeDocument, deleteDocument } =
			...
			<Menu mode="horizontal">
				<SubMenu key="file" title="File">
					<Menu.ItemGroup title="Document">
						...
						>
							{" "}
							<CloseCircleOutlined /> Close Document
						</Menu.Item>
						<Menu.Item
							key="document-delete"
					...
					<Menu.ItemGroup title="Help">
						<Menu.Item key="help-docs">
							<a
								...
								target="_blank"
							>
								<QuestionCircleOutlined /> WPGraphQL
								Documentation
							</a>
						</Menu.Item>
						<Menu.Item key="help-videos">
							<a
								...
								target="_blank"
							>
								<YoutubeOutlined /> Videos
							</a>
						</Menu.Item>
						<Menu.Item key="help-slack">
							<a
