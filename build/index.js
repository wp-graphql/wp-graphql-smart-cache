...
const SaveButton = props => {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(antd__WEBPACK_IMPORTED_MODULE_1__["default"], {
    ...
    ,
    defaultValue: (_props$name = props.name) !== null && _props$name !== void 0 ? _props$name : "",
    placeholder: (_props$name2 = props.name) !== null && _props$name2 !== void 0 ? _props$name2 : "Document name",
    onChange: e => {
  ...
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(GraphiQL.Button, {
    label: `Save As ...`,
    onClick: () => {
      var payload = {
      ...
      var post = fetch(appContext.endpoint, {
        method: "POST",
        headers: {
...
hooks.addFilter('graphiql_toolbar_after_buttons', 'graphiql-persisted-queries', (res, props) => {
  res.push((0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(SaveButton, props));
  return res;
});
}();
/******/ })()
